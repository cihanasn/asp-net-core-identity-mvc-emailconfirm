...
namespace asp_net_core_identity_mvc.Controllers
{
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Register(RegisterViewModel request)
        {
            ...
            message.Content = "Please confirm your account by clicking this link: <a href=\"" + callbackUrl + "\">link</a>";
            _emailSender.Send(message);

            //return RedirectToAction("Index", "Home");
            return RedirectToAction(nameof(AccountController.SuccessRegistration), "Account");
        }
        ...
        public async Task<IActionResult> Login(LoginViewModel request, string returnUrl = null)
        {
            ...
            if (!flag)
            {
                ModelState.AddModelError(string.Empty, "Email Not Confirmed. Please check your email to confirm. ");
                return View(request);
            }
